...
import com.comarch.kiosque.mock.model.Status;
...
public interface AdminApi  {
    ...
    @ApiOperation(value = "Retourne l'̩tat du service", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Etat du service", response = Status.class) })
